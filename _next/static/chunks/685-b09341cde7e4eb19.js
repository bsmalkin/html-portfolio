    ...
    7685: function(t, e, a) {
          ...
          , f = new class {
            constructor() {
                ...
                this.create = t => {
                    ...
                    return r ? this.toasts = this.toasts.map(e => e.id === o ? (this.publish({
                        ...e,
                        ...t,
                        id: o,
                        title: a
        ...
        var v = t => {
            ...
            n.useLayoutEffect( () => {
                ...
                t.style.height = e,
                J(a),
                h(t => t.find(t => t.toastId === p.id) ? t.map(t => t.toastId === p.id ? {
                    ...t,
                    height: a
                } : t) : [{
                    toastId: p.id,
            ...
            , [p, E, h, td]);
            return n.useEffect( () => {
                if (p.promise && "loading" === te || p.duration === 1 / 0 || "loading" === p.type)
                    return;
                let t, e = ti;
                return w || g || L && tg ? ( () => {
                ...
                t = setTimeout( () => {
                    var t;
                    null == (t = p.onAutoClose) || t.call(p, p),
                    tb()
                }
                , e)),
                () => clearTimeout(t)
            ...
            n.createElement("li", {
                ...
                onPointerDown: t => {
                    tv || !ta || (Q.current = new Date,
                    q(td.current),
                    t.target.setPointerCapture(t.pointerId),
                    "BUTTON" !== t.target.tagName && (F(!0),
                    tu.current = {
                        x: t.clientX,
                        y: t.clientY
                    }))
                ...
                onPointerUp: () => {
                    ...
                    if (Math.abs(o) >= 20 || Math.abs(o) / r > .11) {
                        q(td.current),
                        null == (a = p.onDismiss) || a.call(p, p),
                        tb(),
                        V(!0);
                        return
                    }
                    null == (n = Z.current) || n.style.setProperty("--swipe-amount", "0px"),
                    F(!1)
                }
                ,
                onPointerMove: t => {
                ...
                onClick: t => {
                    var e;
                    ta && (tb(),
                    null != (e = p.cancel) && e.onClick && p.cancel.onClick(t))
                }
                ,
                ...
                onClick: t => {
                    var e;
                    null == (e = p.action) || e.onClick(t),
                    t.defaultPrevented || tb()
                }
                ,
        ...
        var y = t => {
            let {invert: e, position: a="bottom-right", hotkey: r=["altKey", "KeyT"], expand: s, closeButton: i, className: l, offset: d, theme: c="light", richColors: u, duration: m, style: p, visibleToasts: g=3, toastOptions: y, dir: x=b(), gap: w, loadingIcon: E, icons: k, containerAriaLabel: N="Notifications", pauseWhenPageIsHidden: B, cn: S=h} = t
              , [T,C] = n.useState([])
              , M = n.useMemo( () => Array.from(new Set([a].concat(T.filter(t => t.position).map(t => t.position)))), [T, a])
              , [z,I] = n.useState([])
              , [R,Y] = n.useState(!1)
              , [P,j] = n.useState(!1)
              , [A,L] = n.useState("system" !== c ? c : window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light")
              , H = n.useRef(null)
              , D = r.join("+").replace(/Key/g, "").replace(/Digit/g, "")
              , U = n.useRef(null)
              , O = n.useRef(!1)
              , W = n.useCallback(t => C(e => e.filter(e => {
                let {id: a} = e;
                return a !== t.id
            }
            )), []);
            ...
            , [H.current]),
            T.length ? n.createElement("section", {
                ...
                return n.createElement("ol", {
                    ...
                    onBlur: t => {
                        O.current && !t.currentTarget.contains(t.relatedTarget) && (O.current = !1,
                        U.current && (U.current.focus({
                            preventScroll: !0
                        }),
                        U.current = null))
                    ...
                    ,
                    onFocus: t => {
                        t.target instanceof HTMLElement && "false" === t.target.dataset.dismissible || O.current || (O.current = !0,
